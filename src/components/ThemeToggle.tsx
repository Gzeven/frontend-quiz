...
//     <ToggleContainer onKeyDown={handleToggleKeyDown} tabIndex={-1} >
//       <ToggleInput type="checkbox" checked={dark} onChange={toggleTheme} tabIndex={0} role="switch" aria-label="Use Dark Mode" aria-checked="false" />
